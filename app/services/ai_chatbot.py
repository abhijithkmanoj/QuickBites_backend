...
Uses Google Gemini API (google.genai) to provide natural-language answers
...
def answer_question(db: Session, question: str) -> str:
    """Answer a customer's question using Google Gemini API and live DB data."""
    ...
    try:
        ...
        return response.text.strip() if response.text else "I couldn't generate an answer. Please try rephrasing your question."
